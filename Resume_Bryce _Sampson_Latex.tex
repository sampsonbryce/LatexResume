...
\color{Black}I created a A* Pathfinding program in C++ that allowed you to create a grid and designate the start, end, and obstacles.\\
\medskip
...
\color{Black}After learning Python, I developed a Battleship game that tracked statistics of the current game and allowed you to save, as well be played with two people on the same device. 
